...
public class MyHeightAndWeight extends LinearLayout implements View.OnTouchListener {
    ...
    private TextView title, year_text, month_text, cancle, sure;
...
//        setListViewWidth(month_listview, listener.getscreenWidth() * 1 / 2);
        ...
        LayoutParams params_relative = (LayoutParams) relative.getLayoutParams();
        ...
        LayoutParams params_tv = (LayoutParams) title.getLayoutParams();
