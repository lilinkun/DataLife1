...
public class MyDateLinear  extends LinearLayout implements View.OnTouchListener {
    ...
    private TextView title, year_text, month_text, day_text, cancle, sure;
    private ListView year_listview, month_listview, day_listview;
    private View view;
    ...
    public void init() {
        ...
        setListViewWidth(year_listview, listener.getscreenWidth() * 2 / 4);
        setListViewWidth(month_listview, listener.getscreenWidth() * 1 / 4);
        setListViewWidth(day_listview, listener.getscreenWidth() * 1 / 4);

        LayoutParams params_relative = (LayoutParams) relative
                .getLayoutParams();
        ...
        LayoutParams params_tv = (LayoutParams) title
                .getLayoutParams();
    ...
    public void initYearArrayList(ArrayList<String> arrayList) {
        for (int i = minYear; i <= maxYear; i++) {
            String str = "" + i + context.getResources().getString(R.string.text_Myinfo_years);
            arrayList.add(str);
        }
    }
    ...
    public void initMonthArrayList(ArrayList<String> arrayList) {
        for (int i = 1; i <= 24; i++) {
            ...
            String str = null;
            if (id == 0) {
                str = "12" + context.getResources().getString(R.string.text_Myinfo_month);
            } else if (id < 10) {
                str = "0" + id + context.getResources().getString(R.string.text_Myinfo_month);
            } else {
                str = "" + id + context.getResources().getString(R.string.text_Myinfo_month);
            }
            arrayList.add(str);
        }
    }
    ...
    public void initDayArrayList(ArrayList<String> arrayList, int year,
        ...
        for (int i = 1; i <= maxDay * 2; i++) {
            ...
            String str = null;
            if (id == 0) {
                str = "" + maxDay + context.getResources().getString(R.string.text_Myinfo_day);
            } else if (id < 10) {
                str = "0" + id + context.getResources().getString(R.string.text_Myinfo_day);
            } else {
                str = "" + id + context.getResources().getString(R.string.text_Myinfo_day);
            }
            arrayList.add(str);
        }
    }
            ...
            public void onScroll(AbsListView arg0, int first, int visible, int totle) {
                switch (state) {
                    ...
                    case DAY:
                        ...
                        day_text.setText(arrayListDay.get(id_day));
                        if (first == 0) {
