...
import com.datalife.datalife.util.CalculateUtil;
...
public class LineChart extends View {
     ...
     * x轴刻度的间距
     */
    private int widthItem = 30;


    /**
     * 背景的颜色
     */
    private static final int BG_COLOR = Color.parseColor("#00EEEEEE");
    /**
     * 视图的宽和高
     */
...
//                new Thread(new SmoothScrollThread(movingThisTime)).start();
    ...
    private void getItemsWidth() {
        space = DensityUtil.dip2px(getContext(), widthItem);
        maxRight = (int) (xStartIndex + space * mData.size() *1.5);
        minRight = mTotalWidth - leftMargin*3;
    }

    public void setData(List<ChartEntity> list,int width) {
        this.mData = list;
